      ...
      <?php 
        if(comments_open()) {
          comment_form(
            array(
              "fields" => array(
                "author" => '<p class="comment-form-author mb-4"><input id="author" name="author" class="outline-none bg-gray-200 dark:bg-gray-800 rounded-lg w-full py-2 px-4 border border-gray-200 dark:border-gray-800 focus:border-blue-500 dark:focus:border-blue-500 transition-all" type="text" value="" size="30" maxlength="245" placeholder="Name*" required="required"></p>',
                "email" => '<p class="comment-form-email mb-4"><input id="email" name="email" class="outline-none bg-gray-200 dark:bg-gray-800 rounded-lg w-full py-2 px-4 border border-gray-200 dark:border-gray-800 focus:border-blue-500 dark:focus:border-blue-500 transition-all" type="text" value="" size="30" maxlength="100" aria-describedby="email-notes" placeholder="Email*" required="required"></p>',
              ...
              "comment_field" => '<p class="comment-form-comment mb-2"><textarea id="comment" name="comment" class="outline-none bg-gray-200 dark:bg-gray-800 rounded-lg w-full py-2 px-4 border border-gray-200 dark:border-gray-800 focus:border-blue-500 dark:focus:border-blue-500 transition-all" cols="45" rows="1" maxlength="65525" placeholder="Comments*" required="required"></textarea></p>',
